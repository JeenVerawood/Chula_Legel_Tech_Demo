...
// TODO [BACKEND]: Replace with GET /api/meetings?status=upcoming — see HANDOFF.md
...
// TODO [BACKEND]: Replace with GET /api/calendar-events — see HANDOFF.md
      ...
      <div className="dashboard-grid">
        ...
        <div className="dashboard-meetings-section">
          <div className="dashboard-meetings-header">
            ...
            <span className="dashboard-meeting-count">{upcomingMeetings.length} รายการ</span>
          </div>
