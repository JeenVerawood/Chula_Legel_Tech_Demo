export interface Question {
    id: string | number;
    title: string;
    type?: "input" | "options" | "agenda" | "textarea";
    placeholder?: string;
    options?: string[];
    [key: string]: any;
}

// ── ผู้ถือหุ้น flow (เดิม) ──────────────────────────────
...
export const directorQuestions: Question[] = [
    ...
    {
        id: "d2",
        title: "วาระการประชุมคืออะไร",
        type: "textarea",
        placeholder: "อธิบายวาระการประชุม เช่น พิจารณาอนุมัติงบประมาณประจำปี 2568...",
    },
];