...
/** Company type options for Thai legal entities */
export type CompanyType = "บจก. (บริษัท จำกัด)" | "บมจ. (บริษัท มหาชน จำกัด)";
...
export type MeetingStatus = "draft" | "upcoming" | "live" | "completed" | "cancelled";
