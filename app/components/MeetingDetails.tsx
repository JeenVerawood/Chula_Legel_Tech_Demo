...
function WaveformVisualization() {
    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            // Draw dual waveforms
            const waves = [
                { color: "rgba(99, 102, 241, 0.35)", amp: 18, freq: 0.02, speed: 0.03, yOffset: 0 },
                { color: "rgba(239, 68, 68, 0.3)", amp: 14, freq: 0.025, speed: 0.02, yOffset: 5 },
            ];
    ...
    return (
        ...
        >
            ...
            <div className="meeting-details-time">
                ...
                <div>
                    <p className="meeting-details-time-label">การประชุมกำลังจะเริ่มเร็ว ๆ นี้</p>
