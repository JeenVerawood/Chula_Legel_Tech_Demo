...
// ---- ประเภทรายชื่อผู้เข้าร่วม ----
interface AttendeeOption {
    id: string;
    label: string; // เช่น "นาย วีรสัก เจรจรูน (ทอม)"
}
...
export default function CreateMeetingForm() {
    ...
    const handleAddNewAttendee = () => {
        ...
        if (!trimmed) return;
        const newOption: AttendeeOption = {
            ...
            <div className="create-form-card">
                ...
                <div className="create-form-field">
                    <div className="create-form-field-header">
                        ...
                        {errors.meetingType && (
                            <span className="create-form-error"><AlertCircle size={12} /> จำเป็น</span>
                        )}
                    </div>
                    <div className="create-form-select-wrapper">
                        {role === "director" ? (
                ...
                {/* 5. Attendees — Dropdown พร้อมเพิ่มรายชื่อ */}
                <div className="create-form-field" ref={attendeesRef}>
                    <div className="create-form-field-header">
                        <label>เรียน</label>
                        {errors.attendees && (
                            <span className="create-form-error"><AlertCircle size={12} /> กรุณาเลือกผู้รับอย่างน้อย 1 คน</span>
                        )}
                    </div>
                        ...
                        <div className="flex flex-wrap gap-2 mb-2">
                            {selectedAttendees.map((a) => (
                                ...
                                >
                                    {a.label}
                                    <button
                                        onClick={() => removeSelectedAttendee(a.id)}
                                    ...
                                    {!showAddAttendee ? (
                                        ...
                                        <div className="px-3 py-2 flex flex-col gap-2">
                                            <input
                                                ...
                                                className="create-form-input text-sm"
                                                autoFocus
                                            />
                                            <div className="flex gap-2">
                                                ...
                                                <button
                                                    onClick={() => { setShowAddAttendee(false); setNewAttendeeName(""); }}
                ...
                <div className="create-form-field">
                    ...
                    <div className={`create-form-signature ${errors.signature ? "create-form-signature-error" : ""}`}>
                        ...
                        />
                        {!isSigned && (
                            <div className="create-form-signature-placeholder">ใช้นิ้ววาดลายเซ็นที่นี่</div>
                        )}
                    </div>
                </div>
